                        ...
                        <div x-data="{
                            ...
                            <div x-show="showModal" x-transition:enter="ease-out duration-300"
                                ...
                                <div class="flex items-center justify-center min-h-screen px-4 py-6">
                                    <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-hidden"
                                        ...
                                        <div class="flex items-center justify-between p-4 border-b border-gray-200">
                                            <h3 class="text-lg font-semibold text-gray-900">Selecionar Segmentações</h3>
                                                    ...
                                                    <label
                                                        ...
                                                        <div class="ml-3 flex-1">
                                                            <div class="text-sm font-medium text-gray-900"
                                                                x-text="segmentacao.nome"></div>
                                                            <div x-show="segmentacao.descricao"
                                                                class="text-xs text-gray-500 mt-1"
                                                                x-text="segmentacao.descricao"></div>
                                                        </div>
                                                    </label>
                                                </template>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <span class="text-sm text-gray-600">
                                                <span x-text="selectedSegmentacoes.length"></span> selecionado(s)
                                            </span>
                                            <button @click="showModal = false"
