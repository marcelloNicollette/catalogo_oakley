<!-- Modal de Sugestão -->
<div id="passwordRecoveryModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <style>
        .btn-bg-black-white {
    ...
    <div class="bg-white rounded-lg w-[630px] mx-4 px-[4rem] lg:px-[8rem] py-[3rem]">
        ...
        <div id="suggestionForm" class="space-y-6">
            ...
            <div class="flex justify-center">
                <button onclick="closePasswordRecoveryModal()"
