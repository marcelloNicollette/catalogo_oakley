    ...
    <style>
        ...
        @if (!isset($isPdf) || $isPdf === false)
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 400;
                src: url('{{ asset('fonts/FONT_MONTSERRAT/Montserrat-Regular.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 600;
                src: url('{{ asset('fonts/FONT_MONTSERRAT/Montserrat-SemiBold.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 700;
                src: url('{{ asset('fonts/FONT_MONTSERRAT/Montserrat-Bold.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 900;
                src: url('{{ asset('fonts/FONT_MONTSERRAT/Montserrat-Black.ttf') }}') format('truetype');
            }
        @endif
        ...
        @if (isset($isPdf) && $isPdf === true)
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 400;
                src: url('file://{{ public_path('fonts/FONT_MONTSERRAT/Montserrat-Regular.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 600;
                src: url('file://{{ public_path('fonts/FONT_MONTSERRAT/Montserrat-SemiBold.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 700;
                src: url('file://{{ public_path('fonts/FONT_MONTSERRAT/Montserrat-Bold.ttf') }}') format('truetype');
            }
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 900;
                src: url('file://{{ public_path('fonts/FONT_MONTSERRAT/Montserrat-Black.ttf') }}') format('truetype');
            }
    ...
    @unless ($remove_capa_retranca)
        ...
        <div class="capa" style="background: #021489; height: 100%;">
            <div style="padding: 5rem;">
                ...
                <div style="position: absolute; bottom: 30px; right: -300px;">
            ...
            <tr>
                ...
                <td width="30%" style="border-radius: 8px; vertical-align: top;">
                    ...
                    <div style="padding:20px 10px 0px 10px;">
                        ...
                        <h1
                            style="font-family: 'Montserrat'; margin: 0px 0 10px 0;
